...
| 判据 | `docs/eggbabe-DESIGN.md`；上位文档为 `docs/蛋宝宝小程序_V3_6_PRD.md` |
...
| i2 | **已统一当前动作口径**：8 个居家状态为睡觉、小憩、发呆、涂涂画画、看书、打游戏、听音乐、看窗外。小憩沿用内部键 `lazy`（历史文档称赖床），睡觉沿用内部键 `sleep`；两者使用独立动作图，不得重复计数。旧版结构说明与 PRD 仍作为历史资料保留。 |
