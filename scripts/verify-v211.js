...
assert.equal(h5Css.includes('--title-ratio: 14%'), true, '标题区比例必须锁定在约 12–15%');
assert.equal(h5Css.includes('--illustration-ratio: 54%'), true, '插画区比例必须锁定在约 50–55%');
assert.equal(h5Css.includes('--data-ratio: 32%'), true, '数据区比例必须约为 30%');
